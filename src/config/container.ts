...
// Пряме зв'язування конкретного класу PrzewalskishorseRepository як одиночного екземпляру
container.bind(PrzewalskishorseRepository).toSelf().inSingletonScope();
